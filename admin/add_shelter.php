...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-main">
        <header class="dashboard-header">
            <div>
                <h2>Add Shelter</h2>
                <p>Register a new shelter location</p>
            </div>
        </header>
            ...
            <div class="box" style="max-width: 800px; margin: 0 auto;">
                <form action="../ajax/admin_actions.php" method="POST" class="ajax-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shelter_name" class="form-control" required placeholder="e.g. City Animal Haven" style="border-radius: 10px; padding: 12px;">
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            <label style="font-weight: 700; color: var(--complementary-color);">City</label>
                            <input type="text" name="city" class="form-control" placeholder="e.g. New York" style="border-radius: 10px; padding: 12px;">
                        </div>
                        <div class="form-group">
                            <label style="font-weight: 700; color: var(--complementary-color);">State</label>
                            <input type="text" name="state" class="form-control" placeholder="e.g. NY" style="border-radius: 10px; padding: 12px;">
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control" maxlength="11" pattern="\d{1,11}" title="Please enter up to 11 digits (numbers only)" placeholder="e.g. 09123456789" style="border-radius: 10px; padding: 12px;" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                        </div>
                        <div class="form-group">
                            <label style="font-weight: 700; color: var(--complementary-color);">Operating Hours</label>
                            <input type="text" name="operating_hours" class="form-control" placeholder="e.g. 9 AM - 5 PM" style="border-radius: 10px; padding: 12px;">
                        </div>
                    </div>

                    <div class="form-group">
                        <label style="font-weight: 700; color: var(--complementary-color);">Description</label>
                        <textarea name="description" class="form-control" rows="4" style="border-radius: 10px; padding: 15px; resize: vertical;"></textarea>
                    </div>

                    <div style="display:flex; gap:15px; margin-top:30px;">
                        <button type="submit" class="btn btn-primary" style="flex:1; border-radius: 10px; font-weight: 700;">Create Shelter</button>
